...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				scheduler_mode TEXT DEFAULT 'round_robin',
					...
					continuous_retry_policy TEXT DEFAULT '{"enabled":false,"categories":["transport","http_429","http_5xx","stream_error"],"status_codes":[],"error_codes":[]}',
	...
	columns := []struct {
		...
		{"system_settings", "continuous_retry_policy", "TEXT DEFAULT '{\"enabled\":false,\"categories\":[\"transport\",\"http_429\",\"http_5xx\",\"stream_error\"],\"status_codes\":[],\"error_codes\":[]}'"},
