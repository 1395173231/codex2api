...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				models_list_read_max_bytes INTEGER NOT NULL DEFAULT 8388608,
                    ...
                    codex_ws_rotation_enabled INTEGER DEFAULT 0,
                    codex_ws_rotation_max_age_sec INTEGER DEFAULT 2700,
                    codex_ws_max_siblings INTEGER DEFAULT 3,
                    codex_ws_max_proxy_routes INTEGER DEFAULT 2,
					...
					auto_reset_credits_on_limit_enabled INTEGER DEFAULT 0,
					codex_analytics_enabled INTEGER DEFAULT 0,
	...
	columns := []struct {
		...
		{"system_settings", "codex_ws_rotation_enabled", "INTEGER DEFAULT 0"},
		{"system_settings", "codex_ws_rotation_max_age_sec", "INTEGER DEFAULT 2700"},
		{"system_settings", "codex_ws_max_siblings", "INTEGER DEFAULT 3"},
		{"system_settings", "codex_ws_max_proxy_routes", "INTEGER DEFAULT 2"},
		...
		{"system_settings", "auto_reset_credits_on_limit_enabled", "INTEGER DEFAULT 0"},
		{"system_settings", "codex_analytics_enabled", "INTEGER DEFAULT 0"},
