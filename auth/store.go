...
type Account struct {
	...
	codexTurnStateManager *CodexTurnStateManager
...
type Store struct {
	...
	stopCh              chan struct{}
	codexTurnStates     atomic.Pointer[CodexTurnStateManager]
	stopOnce            sync.Once
...
func (s *Store) buildAccountFromRow(ctx context.Context, row *database.AccountRow, modelCooldowns map[int64][]*database.AccountModelCooldownRow) *Account {
	...
	account := &Account{
		...
		codexTurnStateManager:        s.codexTurnStates.Load(),
...
func (s *Store) WaitForSessionAvailableWithFilter(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, exclude map[int64]bool, filter AccountFilter) (*Account, string) {
	account, proxyURL, _, _ := s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, nil, false, DispatchPolicyStandard)
	return account, proxyURL
}
...
func (s *Store) WaitForSessionAvailableWithDispatch(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, exclude map[int64]bool, filter AccountFilter, policy DispatchPolicy) (*Account, string) {
	account, proxyURL, _, _ := s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, nil, false, policy)
	return account, proxyURL
}
...
func (s *Store) WaitForSessionAvailableWithDispatchGuard(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, exclude map[int64]bool, filter AccountFilter, policy DispatchPolicy) (*Account, string, SessionAffinityGuard) {
	account, proxyURL, guard, _ := s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, nil, false, policy)
...
func (s *Store) WaitForSessionAvailableWithMessageHashesWithDispatch(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, messageHashes []uint64, exclude map[int64]bool, filter AccountFilter, policy DispatchPolicy) (*Account, string) {
	account, proxyURL, _, _ := s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, messageHashes, false, policy)
	return account, proxyURL
}
...
func (s *Store) WaitForSessionAvailableWithMessageHashesWithDispatchGuard(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, messageHashes []uint64, exclude map[int64]bool, filter AccountFilter, policy DispatchPolicy) (*Account, string, SessionAffinityGuard) {
	account, proxyURL, guard, _ := s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, messageHashes, false, policy)
	return account, proxyURL, guard
}
...
func (s *Store) WaitForContinuationAvailableWithFilter(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, exclude map[int64]bool, filter AccountFilter) (*Account, string) {
	account, proxyURL, _, _ := s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, nil, true, DispatchPolicyStandard)
	return account, proxyURL
}
...
func (s *Store) WaitForContinuationAvailableWithDispatch(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, exclude map[int64]bool, filter AccountFilter, policy DispatchPolicy) (*Account, string) {
	account, proxyURL, _, _ := s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, nil, true, policy)
	return account, proxyURL
}
...
func (s *Store) WaitForDispatchAvailable(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, exclude map[int64]bool, filter AccountFilter, preserveBinding bool, policy DispatchPolicy, heartbeat ...SchedulerWaitHeartbeat) (*Account, string, SessionAffinityGuard, error) {
	return s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, nil, preserveBinding, policy, heartbeat...)
}

// WaitForDispatchAvailableWithMessageHashes additionally threads content-derived
// message hashes for hash-based account affinity.
func (s *Store) WaitForDispatchAvailableWithMessageHashes(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, messageHashes []uint64, exclude map[int64]bool, filter AccountFilter, preserveBinding bool, policy DispatchPolicy, heartbeat ...SchedulerWaitHeartbeat) (*Account, string, SessionAffinityGuard, error) {
	return s.waitForSessionAvailableWithFilter(ctx, key, timeout, apiKeyID, exclude, filter, messageHashes, preserveBinding, policy, heartbeat...)
}

func (s *Store) waitForSessionAvailableWithFilter(ctx context.Context, key string, timeout time.Duration, apiKeyID int64, exclude map[int64]bool, filter AccountFilter, messageHashes []uint64, preserveBinding bool, policy DispatchPolicy, heartbeat ...SchedulerWaitHeartbeat) (*Account, string, SessionAffinityGuard, error) {
	if ctx == nil {
		ctx = context.Background()
	}
...
func (s *Store) AddAccounts(accounts []*Account) {
	...
	for _, acc := range accounts {
		...
		acc.codexTurnStateManager = s.codexTurnStates.Load()
